...
//widgetized footer
	register_sidebar(array(
		'name' => __( 'Footer Widget 1', 'skillcrushstarter' ),
		'id'        => 'footer-1',
	...
	register_sidebar(array(
		'name' => __( 'Footer Widget 2', 'skillcrushstarter' ),
		'id'        => 'footer-2',
		'description' => __( 'Add widgets here to appear in your footer.', 'skillcrushstarter' ),
		'before_widget' => '<footer id="%1$s" class="widget %2$s">',
		'after_widget' => '</footer>',
	...
	register_sidebar(array(
		'name' => __( 'Footer Widget 3', 'skillcrushstarter' ),
		'id'        => 'footer-3',
		'description' => __( 'Add widgets here to appear in your footer.', 'skillcrushstarter' ),
		'before_widget' => '<footer id="%1$s" class="widget %2$s">',
		'after_widget' => '</footer>',
	...
	register_sidebar(array(
		'name' => __( 'Footer Widget 4', 'skillcrushstarter' ),
		'id'        => 'footer-4',
		'description' => __( 'Add widgets here to appear in your footer.', 'skillcrushstarter' ),
		'before_widget' => '<footer id="%1$s" class="widget %2$s">',
		'after_widget' => '</footer>',
